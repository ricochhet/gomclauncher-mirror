...
func init() {
	...
	flag.BoolVar(&f.Verlistfabric, "verlistfabric", false, lang.Lang("verlistfabricusage"))
	flag.BoolVar(&f.Verlistquilt, "verlistquilt", false, lang.Lang("verlistquiltusage"))
